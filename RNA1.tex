...
\item Aprender mediante un enfoque distinto el funcionamiento del sistema nervioso mediante la simulación de las redes neuronales.

\item Dar a conocer cómo trabaja una red neuronal y sus diferentes formas de aprendizaje.
\end{itemize}
